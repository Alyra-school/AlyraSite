...
const config = programSegmentConfigs.ia;

export const metadata = pageMetadata({
  title: config.title,
  description: config.description,
  path: "/formations/intelligence-artificielle",
});

export default async function FormationsIAPage() {
  const programs = await getPrograms();
  const filtered = getProgramSegmentPrograms(programs, "ia");
