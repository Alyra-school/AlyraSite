export const programs = [
  {
    title: "Fondations Web3",
    duration: "8 semaines",
    level: "Debutant",
    desc:
      "Comprendre les blockchains, les wallets, la securite et le design de produits Web3.",
  },
  {
    title: "Developpeur Smart Contracts",
    duration: "12 semaines",
    level: "Intermediaire",
    desc:
      "Construire, tester et deployer des smart contracts avec audits de base.",
  },
  {
    title: "Data & Finance Decentralisee",
    duration: "10 semaines",
    level: "Avance",
    desc:
      "Explorer la DeFi, la tokenisation et l'analyse on-chain pour les equipes produit.",
  },
];
...
export const learnerFeedback = [
  {
    name: "Camille R.",
    role: "Alumni - Dev Blockchain",
    quote:
      "J'ai gagne en confiance tres vite. Le format projet et le mentorat m'ont aide a decrocher mon premier poste web3.",
  },
  {
    name: "Yassine B.",
    role: "Alumni - IA",
    quote:
      "Le rythme est exigeant mais tres structurant. Les retours des formateurs etaient concrets et applicables immediatement.",
  },
  {
    name: "Marion T.",
    role: "Alumni - DeFi",
